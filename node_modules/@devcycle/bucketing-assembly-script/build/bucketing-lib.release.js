exports.instantiate = async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    ...
    testSortObjectsByString(arr, direction) {
      ...
      arr = __retain(__lowerArray((pointer, value) => { __setU32(pointer, __lowerRecord191(value) || __notnull()); }, 192, 2, arr) || __notnull());
      direction = __lowerString(direction) || __notnull();
      try {
        return __liftArray(pointer => __liftRecord190(__getU32(pointer)), 2, exports.testSortObjectsByString(arr, direction) >>> 0);
      } finally {
        __release(arr);
      }
    },
  ...
  function __lowerRecord190(value) {
    // assembly/testHelpers/TestData
    // Hint: Opt-out from lowering as a record by providing an empty constructor
    if (value == null) return 0;
    const pointer = exports.__pin(exports.__new(4, 190));
    __setU32(pointer + 0, __lowerString(value.key) || __notnull());
    exports.__unpin(pointer);
    return pointer;
  }
  function __lowerRecord191(value) {
    // assembly/helpers/arrayHelpers/SortingArrayItem<assembly/testHelpers/TestData>
    // Hint: Opt-out from lowering as a record by providing an empty constructor
    if (value == null) return 0;
    const pointer = exports.__pin(exports.__new(8, 191));
    __setU32(pointer + 0, __lowerString(value.value) || __notnull());
    __setU32(pointer + 4, __lowerRecord190(value.entry) || __notnull());
    exports.__unpin(pointer);
    return pointer;
  }
  function __liftRecord190(pointer) {
    // assembly/testHelpers/TestData
