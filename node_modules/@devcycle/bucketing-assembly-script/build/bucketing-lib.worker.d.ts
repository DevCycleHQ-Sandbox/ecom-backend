declare namespace __AdaptedExports {
   ...
   * @returns `bool`
   */
  export function evaluateOperatorFromJSON(operatorStr: string, userStr: string, audiencesStr?: string | null): boolean;
  /**
   ...
   */
  export function testSortObjectsByString(arr: Array<__Record191<undefined>>, direction: string): Array<__Record190<never>>;
  /**
