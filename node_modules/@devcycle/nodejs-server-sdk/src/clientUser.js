...
exports.generateClientPopulatedUser = void 0;
/**
 ...
 */
const generateClientPopulatedUser = async (user, userAgent) => {
    const prefix = '@devcycle/';
    const suffix = 'js-client-sdk';
    const clientSdk = await import(prefix + suffix);
    return new clientSdk.DVCPopulatedUser(user, {}, undefined, undefined, userAgent !== null && userAgent !== void 0 ? userAgent : undefined);
};
exports.generateClientPopulatedUser = generateClientPopulatedUser;
